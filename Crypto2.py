...
# Print ECC public key and prime in extractable format
print(f"ECC Public Key: {public_key.export_key(format='OpenSSH')}")
print(f"ECC Prime (Curve Modulus): {ECC._curves['P-256'].p}")  # Get prime modulus
